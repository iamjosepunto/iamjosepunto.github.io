...
const Nav = () => {
  ...
  return (
    <header className="sticky top-0 z-50 backdrop-blur bg-slate-950/80 border-b border-slate-800">
      <nav className="relative max-w-full mx-auto px-6 h-16 flex items-center justify-between gap-4">
        <a
          href="#"
        ...
        {/* Desktop */}
        <ul className="hidden md:flex absolute left-1/2 -translate-x-1/2 gap-4 lg:gap-5 text-ivory whitespace-nowrap">
          <li>
